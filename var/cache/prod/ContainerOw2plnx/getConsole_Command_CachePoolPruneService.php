...
$this->services['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () {
    ...
    yield 'doctrine.result_cache_pool' => ${($_ = isset($this->services['doctrine.result_cache_pool']) ? $this->services['doctrine.result_cache_pool'] : $this->load('getDoctrine_ResultCachePoolService.php')) && false ?: '_'};
}, 2));
