...
$a = ${($_ = isset($this->services['doctrine.system_cache_pool']) ? $this->services['doctrine.system_cache_pool'] : $this->load('getDoctrine_SystemCachePoolService.php')) && false ?: '_'};

$b = new \Symfony\Component\Cache\DoctrineProvider($a);

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\Entity'))), 'App\\Entity');

$d = new \Doctrine\ORM\Configuration();
$d->setEntityNamespaces(array('App' => 'App\\Entity'));
$d->setMetadataCacheImpl($b);
$d->setQueryCacheImpl($b);
$d->setResultCacheImpl(new \Symfony\Component\Cache\DoctrineProvider(${($_ = isset($this->services['doctrine.result_cache_pool']) ? $this->services['doctrine.result_cache_pool'] : $this->load('getDoctrine_ResultCachePoolService.php')) && false ?: '_'}));
...
$d->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\FlightRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\FlightRepository']) ? $this->services['App\Repository\FlightRepository'] : $this->load('getFlightRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\ReservationRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\ReservationRepository']) ? $this->services['App\Repository\ReservationRepository'] : $this->load('getReservationRepositoryService.php')) && false ?: '_'};
